	...
	<view class="dropdonw-wrap">
		...
		<view class="abs">
			<view class="drop-content" @click="downpopShow = !downpopShow">
				<text v-if="text" style="color: #000;">{{text}}</text>
				<text style="color: #fff;" v-else>{{placeholder}}</text>
				<!-- <image src="../static/bdropup.png" mode="aspectFit" style="width: 28upx; height: 28upx;"
					v-if="downpopShow == false"></image>
				<image src="../static/bdropdown.png" mode="aspectFit" style="width: 28upx; height: 28upx;"
					v-else-if="downpopShow == true"></image> -->
				<image src="../static/bbdropup.png" mode="aspectFit" style="width: 28upx; height: 28upx;"
					></image>
			</view>
