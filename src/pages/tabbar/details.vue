...
<!-- 				<button  class="page-body-button" @click="storp(movieData,2)">Give up the task</button> -->
				  <button :disabled="disabledflag"  class="page-body-button1"  @click="storp(movieData,1)">{{t('movie.m_d6')}}</button>
			</view>
		</view>
...
<!-- 					RATE THIS -->
				...
				<button class='btnRate' :style="grade?'background-color: #DE3824;color:#fff':'background-color: #DE3824;color: #fff'" @click="submitScore(grade)">
<!-- 					Rate -->
					{{t('movie.m_d1')}}
				</button>
