<template>
	<view :style="store.$state.imgObj.loginBg">
		<view class="pdlr35 pt33">
			...
			<view class="f50 mt60 text_bold" :style="{color:store.$state.thirdColor}"> {{t('mine.m_a1')}}</view>
			...
			<view class="mt58 between f28"
				style="background-color: #314539;border-radius: 20rpx;	overflow: hidden;height: 90rpx;">
